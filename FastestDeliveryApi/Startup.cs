...
namespace FastestDeliveryApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            builder.Database = "ISPr24-39_BeluakovDS_FastestDeliveryDatabase";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FastestDeliveryApi", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FastestDeliveryApi v1"));
            }
